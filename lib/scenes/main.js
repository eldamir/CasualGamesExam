...
MainScene.prototype.addAssets = function(stage) {
    ...
    var mainMenuText = new createjs.Text("Main Menu", "30px Arial", "black");
    ...
    stage.addChild(
        Button({
            ...
            onClick: function (e) {
                ...
                gameBoardScene.rules.multiPlayer = true;
                // TODO: Add the second player somehow
                game.setScene(gameBoardScene);
            }
        })
    );
    stage.addChild(
        Button({
            ...
            onClick: function (e) {
                ...
                game.setScene(new NotImplementedScene(game));
            }
        })
    );

    // Adding mute button
    stage.addChild(game.hud.muteButton);
};