...
GameBoardScene.prototype.setupMuteButton = function () {
    var game = this.game;
    this.hud.muteButton = Button({
        image: "lib/media/images/playing.png",
        imageScale: 0.2,
        x: this.getBounds()[1] + 12 + (128 * 0.2 / 2),
        y: this.getBounds()[3] - 12 - (128 * 0.2),
        width: 20,
        height: 20,
        center: true,
        onClick: function (e) {
    ...
    game.stage.addChild(this.hud.muteButton);
