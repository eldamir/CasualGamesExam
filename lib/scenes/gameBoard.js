...
GameBoardScene.prototype.doMouseBehaviour = function () {
    // The chances of action. The numbers are enterpreted as one in FOO, e.g. spawnChance = 300 -> 1/300
    var spawnChance = 300;
    var moveChance = 5;
...
GameBoardScene.prototype.getBounds = function () {
    return [this.gameBoard.x, this.gameBoard.width, this.gameBoard.y, this.game.height]
};