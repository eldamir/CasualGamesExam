...
GameBoardScene.prototype.addAssets = function(stage) {
    ...
    this.muteBtn = new createjs.Bitmap("lib/media/images/playing.png");
    this.muteBtn.x = 820;
    this.muteBtn.y = 550;
    this.muteBtn.scaleX = this.muteBtn.scaleY = 0.2;
...
GameBoardScene.prototype.onTick = function () {
    ...
    // Muting sound
    // TODO: WHY WONT THIS WORK???? DOESN'T MATTER WHERE I PUT THE 'ON' METHOD..
    //this.muteBtn.on("click", this.muteSound());
...
GameBoardScene.prototype.updateScoreBox = function () {
    this.hud.scoreBox.text = "Score: " + this.score;
};

GameBoardScene.prototype.setupScoreBox = function () {
    var scoreBox = new createjs.Text("Score", "20px Arial", "black");
    scoreBox.x = this.getBounds()[1] + 12;
    scoreBox.y = 12;
    this.hud['scoreBox'] = scoreBox;
    this.game.stage.addChild(scoreBox);
    this.updateScoreBox();
};
...
GameBoardScene.prototype.muteSound = function () {
    this.game.backgroundSound.muted = true;
}
