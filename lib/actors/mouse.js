...
function Mouse(options) {
    ...
    var extraSpace = this.game.currentScene.getBounds()[0];
    var padding = 15;  // Prevents mice from spawning at the borders, getting stuck
    var randPosX = getRandomInt(padding + extraSpace,  this.game.currentScene.gameBoard.width - padding);
    var randPosY = getRandomInt(padding, this.game.currentScene.gameBoard.height - padding);
